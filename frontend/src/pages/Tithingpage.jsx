    ...
    <>
      <div className="container my-5 py-5 ">
        <div className="row my-5">
          <h1 className="text-center text-danger text-uppercase mt-5 pt-2 text-lg">
            What is Tithing?
          </h1>
            ...
            <div className="card shadow">
              ...
              <div className="card-body">
                <p>
                  ...
                  individuals. It means giving 10 percent from your daily,
                  monthly and annual income. It involves setting aside a
                  specific portion of one's income, whether it's from monthly
                  salaries, daily wages, or any other sources, to donate to the
            ...
            <div className="card shadow">
              ...
              <div className="card-body">
                <p>
                  ...
                  portion of their agricultural produce, Instead of giving
                  money, such as crops, fruits, or vegetables, to the church.
                  This donated food is then used to feed the needy people and
        ...
        <div className="row my-5">
          <h1 className="text-center text-uppercase text-danger text-lg pt-5">
            Division of Tithe
          </h1>
        ...
        <div className="row ">
          <div className="col-lg-4 mt-5">
            <h2 className="text-uppercase text-danger">Tithing to the Widow</h2>
            <div className="mt-4">
              <p className="text-secondary">
        ...
        <div className="row">
          <h1 className="text-uppercase text-center my-5 text-danger text-lg">
            When we can give?
          </h1>
          <div className="col-lg-4">
            <h2 className="mt-3 text-danger">Daily Basis</h2>
            <div>
              <p className="text-secondary">
          ...
          <div className="col-lg-4">
            <h2 className="mt-3 text-danger">Monthly Basis</h2>
            <div>
              <p className="text-secondary">
          ...
          <div className="col-lg-4">
            <h2 className="mt-3 text-danger">Yearly Basis</h2>
            <div>
              <p className="text-secondary">
          ...
          <div className="col-lg-12 my-5">
            ...
            <div className="text-center mt-3">
              <p className="text-secondary">
                ...
                Christianity, tithing is an expression of <br /> love and
                compassion that knows no religious boundaries. It encourages{" "}
                <br /> believers to extend help and support to people of all
                faiths.
              </p>
            </div>
          </div>
